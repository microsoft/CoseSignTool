...
- [Remote Signing](guides/remote-signing.md) - Azure Artifact Signing and other remote services
...
| [CoseSign1.Certificates.AzureArtifactSigning](components/azure-artifact-signing.md) | Azure Artifact Signing |
