...
use cose_sign1_primitives::{
    ...
    CoseHeaderMap, CoseSign1Builder,
};
...
impl crypto_primitives::CryptoSigner for MockSigner {
    ...
    fn sign_init(
        ...
        Err(crypto_primitives::CryptoError::UnsupportedAlgorithm(
            self.algorithm,
        ))
    }
}
...
fn test_builder_with_unprotected_headers() {
    ...
    unprotected.insert(
        ...
        CoseHeaderValue::Text("custom_unprotected".to_string().into()),
    );
