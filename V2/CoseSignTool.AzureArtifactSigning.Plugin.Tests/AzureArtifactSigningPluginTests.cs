...
/// <summary>
/// Tests for AzureArtifactSigningPlugin.
/// </summary>
[TestFixture]
public class AzureArtifactSigningPluginTests
{
    [Test]
    public void Name_ReturnsCorrectName()
    {
        // Arrange
        var plugin = new AzureArtifactSigningPlugin();

        // Act
        var name = plugin.Name;

        // Assert
        Assert.That(name, Is.EqualTo("Azure Artifact Signing"));
    }
    ...
    public void GetExtensions_SigningCommandProviders_ReturnsAzureProvider()
    {
        ...
        Assert.That(providers, Has.Some.Matches<ISigningCommandProvider>(p => p.CommandName == "x509-aas"));
    }
