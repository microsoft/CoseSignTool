...
**Package**: `CoseSignTool.AzureArtifactSigning.Plugin`  
**Purpose**: Azure Artifact Signing integration for the CoseSignTool CLI

## Overview

This plugin enables cloud-based code signing using Azure Artifact Signing service. Azure Artifact Signing provides:
...
1. **Azure Subscription** with Azure Artifact Signing enabled
2. **Artifact Signing Account** configured in Azure
3. **Certificate Profile** created in your Artifact Signing Account
...
### 1. Create a Artifact Signing Account
