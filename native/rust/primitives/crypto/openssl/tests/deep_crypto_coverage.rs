...
fn der_to_fixed_s_out_of_bounds() {
    ...
    let result = der_to_fixed(&[0x30, 0x06, 0x02, 0x01, 0x42, 0x02, 0x20, 0x43], 64);
    assert!(result.is_err());
}

#[test]
fn der_to_fixed_missing_r_integer_tag() {
    let result = der_to_fixed(&[0x30, 0x06, 0x04, 0x01, 0x42, 0x02, 0x01, 0x43], 64);
    assert!(result.is_err());
}

#[test]
fn der_to_fixed_missing_s_integer_tag() {
    let result = der_to_fixed(&[0x30, 0x06, 0x02, 0x01, 0x42, 0x04, 0x01, 0x43], 64);
    assert!(result.is_err());
}
...
fn der_to_fixed_length_mismatch() {
    ...
    let result = der_to_fixed(&[0x30, 0x81, 0xFF, 0x02, 0x01, 0x42, 0x02, 0x01, 0x43], 64);
    assert!(result.is_err());
}
