...
/// <summary>
/// Tests for CertificateCommonNameAssertionProvider.
/// </summary>
[TestFixture]
[System.Runtime.Versioning.RequiresPreviewFeatures("Uses preview cryptography APIs.")]
public class CertificateCommonNameAssertionProviderTests
{
    ...
    {
        var validator = new CertificateCommonNameAssertionProvider("TestCN");
    ...
    {
        var validator = new CertificateCommonNameAssertionProvider("TestCN", allowUnprotectedHeaders: true);
        Assert.That(validator, Is.Not.Null);
    }
    ...
    {
        var validator = new CertificateCommonNameAssertionProvider(TestCertCN);
        var result = validator.Validate(null!, ValidationStage.KeyMaterialTrust);

        Assert.Multiple(() =>
        {
            Assert.That(result.IsValid, Is.False);
            Assert.That(result.ValidatorName, Is.EqualTo(nameof(CertificateCommonNameAssertionProvider)));
    ...
    public void Validate_WithMatchingCommonNameCaseInsensitive_ReturnsSuccess()
    {
        ...
        var validator = new CertificateCommonNameAssertionProvider(TestCertCN.ToUpperInvariant());
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    {
        using var ctx = CreateTestContext();
        var validator = new CertificateCommonNameAssertionProvider("WrongCN");
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    {
        using var ctx = CreateTestContext();
        var validator = new CertificateCommonNameAssertionProvider(TestCertCN, allowUnprotectedHeaders: true);
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    public void Validate_WithPartialCnMatch_ReturnsFailure()
    {
        ...
        var validator = new CertificateCommonNameAssertionProvider("CommonName");
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    public void Validate_WithCnHavingSpecialCharacters_MatchesCorrectly()
    {
        ...
        var validator = new CertificateCommonNameAssertionProvider("Test.User@example.com");
        var result = validator.Validate(message, ValidationStage.KeyMaterialTrust);
    ...
    {
        using var ctx = CreateTestContext();
        var validator = new CertificateCommonNameAssertionProvider("commonnametest");
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
