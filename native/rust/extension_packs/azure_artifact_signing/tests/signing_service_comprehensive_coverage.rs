...
fn test_options_cloning() {
    ...
    assert_eq!(
        ...
        cloned_options.certificate_profile_name
    );
}
...
fn test_options_field_access() {
    ...
    assert_eq!(
        options.endpoint,
        "https://field-access.codesigning.azure.net/"
    );
...
fn test_options_with_special_characters() {
    ...
    assert!(special_options
        .certificate_profile_name
        .contains("special-profile_456"));
}
...
fn test_options_equality() {
    ...
    assert_eq!(
        options1.certificate_profile_name,
        options2.certificate_profile_name
    );
    ...
    assert_ne!(
        options1.certificate_profile_name,
        options3.certificate_profile_name
    );
}
...
fn test_options_consistency_across_operations() {
    ...
    assert_eq!(
        clone1.certificate_profile_name,
        clone2.certificate_profile_name
    );
