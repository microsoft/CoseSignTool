...
#endif
#ifdef COSE_HAS_MST_PACK
    ASSERT_EQ(cose_validator_builder_with_mst_pack(builder.native_handle()), COSE_OK);
#endif
#ifdef COSE_HAS_AKV_PACK
    ASSERT_EQ(cose_validator_builder_with_akv_pack(builder.native_handle()), COSE_OK);
#endif
