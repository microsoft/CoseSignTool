...
/// CertificateRequest.Create(issuerCertificate, ...) doesn't yet fully support ML-DSA OIDs.
/// </remarks>
internal sealed class MLDsaX509SignatureGenerator : X509SignatureGenerator
{
    ...
    /// <param name="hashAlgorithm">The hash algorithm (not used by ML-DSA - it has built-in hashing).</param>
