...
/// Azure Artifact Signing, HSM, etc.) to work with the standard <see cref="CertificateSigningService"/>.
/// </remarks>
public class RemoteCertificateSigningKey : ICertificateSigningKey
{
    ...
    private IReadOnlyList<X509Certificate2> GetCachedChain()
    {
        ...
        lock (ChainLock)
        {
            ...
            ICertificateChainBuilder chainBuilder = CertificateSource.GetChainBuilder();
            X509Certificate2 cert = CertificateSource.GetSigningCertificate();
