...
/// Implements <see cref="ICertificateSigningKey"/> for scenarios requiring certificate chain
/// access and signing service integration.
/// </summary>
/// <remarks>
/// <para>
/// This class uses <see cref="ICertificateSource"/> for certificate management and
...
public class CertificateSigningServiceKey : ICertificateSigningKey
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="CertificateSigningServiceKey"/>.
    /// </summary>
    ...
    public CertificateSigningServiceKey(
