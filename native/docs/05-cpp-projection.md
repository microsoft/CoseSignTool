...
For the full C++ developer guide (including vcpkg consumption), see `native/c_pp/docs/README.md`.
...
- Headers live in `native/c_pp/include/`.
...
- Examples: `native/c_pp/examples/`
- Tests: `native/c_pp/tests/`
