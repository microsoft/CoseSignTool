// C header for the cose-openssl-ffi static library.

#ifndef COSE_OPENSSL_FFI_H
#define COSE_OPENSSL_FFI_H
 ...
 */
int32_t cose_sign(const uint8_t *phdr, size_t phdr_len, const uint8_t *uhdr,
 ...
 *
 * Same as cose_sign but the COSE_Sign1 envelope carries a CBOR null instead
 * of the payload.
 *
 * @return 0 on success, -1 on error.
 */
int32_t cose_sign_detached(const uint8_t *phdr, size_t phdr_len,
 ...
 */
int32_t cose_verify(const uint8_t *envelope, size_t envelope_len,
                    const uint8_t *key_der, size_t key_der_len);
 ...
 * @return             1 if valid, 0 if invalid, -1 on error.
 */
int32_t cose_verify_detached(const uint8_t *envelope, size_t envelope_len,
                             const uint8_t *payload, size_t payload_len,
                             const uint8_t *key_der, size_t key_der_len);
