...
/// <summary>
/// Generates DID:X509 identifiers specifically for Azure Artifact Signing certificates.
...
/// <remarks>
/// <para>
/// Azure Artifact Signing certificates include Microsoft-specific Enhanced Key Usage (EKU) extensions
...
/// </para>
/// </remarks>
public static class AzureArtifactSigningDidX509
{
    /// <summary>
    ...
    public static string Generate(IEnumerable<X509Certificate2> certificateChain)
    {
        ...
        {
            // Use EKU-based format for Azure Artifact Signing certificates
    ...
    internal static class ClassStrings
    {
        ...
        public const string ErrorNoMicrosoftEkuFoundInCertificate = "No Microsoft EKU found in certificate. Azure Artifact Signing certificates should contain Microsoft-specific EKU extensions.";
    }
