...
| `CoseSign1.Certificates.AzureArtifactSigning` | Azure Artifact Signing |
...
| `CoseSignTool.AzureArtifactSigning.Plugin` | Azure Artifact Signing commands |
...
| Azure Artifact Signing | `TrustedSigningCertificateSource` | Managed signing service |
...
+-- sign-azure ...            # Plugin: AzureArtifactSigning
```
