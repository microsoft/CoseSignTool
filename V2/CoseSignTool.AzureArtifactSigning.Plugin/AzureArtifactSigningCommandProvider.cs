...
/// <summary>
/// Command provider for signing with Azure Artifact Signing service.
/// </summary>
public class AzureArtifactSigningCommandProvider : ISigningCommandProvider
{
    ...
    internal static class ClassStrings
    {
        ...
        public static readonly string MetadataValueCertificateSource = "Azure Artifact Signing";
