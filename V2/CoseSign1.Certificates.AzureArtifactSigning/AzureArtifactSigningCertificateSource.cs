...
/// <summary>
/// Provides certificate and signing operations using Azure Artifact Signing service.
/// Implements the RemoteCertificateSource pattern for V2 architecture.
/// </summary>
/// <remarks>
/// Azure Artifact Signing is a Microsoft-managed cloud service that provides:
...
/// 
/// This class wraps the Azure Developer Artifact Signing SDK (AzSignContext) and adapts it
/// to the V2 RemoteCertificateSource pattern.
/// </remarks>
public class AzureArtifactSigningCertificateSource : RemoteCertificateSource
{
    [ExcludeFromCodeCoverage]
    internal static class ClassStrings
    {
        public const string ErrorAzTrustedSigningDidNotReturnCertificateChain = "Azure Artifact Signing did not return a certificate chain. Please check the Azure Artifact Signing configuration and ensure the signing profile is valid.";
        public const string ErrorAzTrustedSigningReturnedEmptyCertificateChain = "Azure Artifact Signing returned an empty certificate chain. Please check the Azure Artifact Signing configuration.";
        public const string ErrorAzTrustedSigningDidNotReturnSigningCertificate = "Azure Artifact Signing did not return a signing certificate.";

        public const string ErrorEcdsaNotSupportedUseRsa = "ECDSA signing is not currently supported by Azure Artifact Signing CryptoProvider. Use RSA signing operations instead.";
        public const string ErrorMldsaNotSupportedMayBeAvailableFuture = "Azure Artifact Signing does not currently support ML-DSA (post-quantum) signing operations. This feature may be available in future versions of the service.";
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AzureArtifactSigningCertificateSource"/> class.
    /// </summary>
    /// <param name="signContext">The Azure Artifact Signing context from the SDK.</param>
    ...
    /// <exception cref="InvalidOperationException">Thrown when Azure Artifact Signing does not provide a usable certificate chain.</exception>
    public AzureArtifactSigningCertificateSource(
    ...
    /// <inheritdoc/>
    /// <exception cref="InvalidOperationException">Thrown when Azure Artifact Signing does not return a signing certificate.</exception>
    public override X509Certificate2 GetSigningCertificate()
    {
        ...
        lock (CertificateLock)
        {
            ...
            // Get the certificate from Azure Artifact Signing SDK
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// ECDSA is not currently supported by Azure Artifact Signing CryptoProvider SDK.
    /// </remarks>
