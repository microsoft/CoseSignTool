...
[TestFixture]
public class CertificateExpirationAssertionProviderTests
{
    [Test]
    ...
    {
        // Act
        var validator = new CertificateExpirationAssertionProvider(allowUnprotectedHeaders: true);
    ...
    public void Constructor_WithValidationTime_CreatesInstance()
    {
        ...
        // Act
        var validator = new CertificateExpirationAssertionProvider(validationTime);
    ...
    public void Constructor_WithValidationTimeAndAllowUnprotected_CreatesInstance()
    {
        ...
        // Act
        var validator = new CertificateExpirationAssertionProvider(validationTime, allowUnprotectedHeaders: true);
    ...
    public void Validate_WithNullInput_ReturnsFailure()
    {
        ...
        Assert.That(result.ValidatorName, Is.EqualTo(nameof(CertificateExpirationAssertionProvider)));
    ...
    public void Validate_WithExpiredCertificate_ReturnsFailure()
    {
        ...
        var validator = new CertificateExpirationAssertionProvider(futureTime);
    ...
    public void Validate_WithNotYetValidCertificate_ReturnsFailure()
    {
        ...
        var validator = new CertificateExpirationAssertionProvider(pastTime);
    ...
    public void Validate_WithSpecificValidationTime_UsesProvidedTime()
    {
        ...
        var validator = new CertificateExpirationAssertionProvider(specificTime);
