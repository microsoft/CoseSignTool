...
/// <summary>
/// Tests for <see cref="AzureArtifactSigningDidX509"/>.
/// </summary>
[TestFixture]
[System.Runtime.Versioning.RequiresPreviewFeatures("Uses preview cryptography APIs.")]
public class AzureArtifactSigningDidX509Tests
{
    /// <summary>
    /// Creates a test certificate for use in tests.
    /// </summary>
    private static X509Certificate2 CreateTestCert(string name = "AzureArtifactSigningDidX509Test")
    ...
    public void Generate_WithNullChain_ThrowsArgumentNullException()
    {
        ...
        var ex = Assert.Throws<ArgumentNullException>(() =>
            AzureArtifactSigningDidX509.Generate(null!));
    ...
    public void Generate_WithEmptyChain_ThrowsArgumentException()
    {
        ...
        var ex = Assert.Throws<ArgumentException>(() =>
            AzureArtifactSigningDidX509.Generate(emptyChain));
    ...
    public void Generate_WithCertWithoutMicrosoftEku_ThrowsInvalidOperationException()
    {
        ...
        Assert.Throws<InvalidOperationException>(() =>
            AzureArtifactSigningDidX509.Generate(chain));
    }
    ...
    public void GenerateWithEku_WithNullLeafCertificate_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var ex = Assert.Throws<ArgumentNullException>(() =>
            AzureArtifactSigningDidX509.GenerateWithEku(null!, testCert2));
    ...
    public void GenerateWithEku_WithNullCaCertificate_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var ex = Assert.Throws<ArgumentNullException>(() =>
            AzureArtifactSigningDidX509.GenerateWithEku(testCert, null!));
    ...
    public void GenerateWithEku_WithCertWithoutMicrosoftEku_ThrowsInvalidOperationException()
    {
        ...
        var ex = Assert.Throws<InvalidOperationException>(() =>
            AzureArtifactSigningDidX509.GenerateWithEku(testCert, testCert2));
    ...
    public void Generate_WithMicrosoftEku_ReturnsValidDidX509()
    {
        ...
        // Act
        var result = AzureArtifactSigningDidX509.Generate(chain);
    ...
    public void GenerateWithEku_WithMicrosoftEku_ReturnsValidDidX509()
    {
        ...
        // Act
        var result = AzureArtifactSigningDidX509.GenerateWithEku(leafCert, rootCert);
    ...
    public void Generate_WithEnumerableChain_WorksCorrectly()
    {
        ...
        // Act
        var result = AzureArtifactSigningDidX509.Generate(GetCerts());
