...
/// <summary>
/// Tests for <see cref="AzureArtifactSigningCertificateSource"/>.
/// Uses mocked AzSignContext to test signing operations.
/// </summary>
[TestFixture]
[System.Runtime.Versioning.RequiresPreviewFeatures("Uses preview cryptography APIs.")]
public class AzureArtifactSigningCertificateSourceTests
{
    /// <summary>
    /// Creates a test certificate for use in tests.
    /// </summary>
    private static X509Certificate2 CreateTestCert(string name = "AzureArtifactSigningTest")
    ...
    public void Constructor_WithNullSignContext_ThrowsArgumentNullException()
    {
        ...
        new AzureArtifactSigningCertificateSource(null!));
    }
    ...
    public void Constructor_WithNullCertChain_ThrowsInvalidOperationException()
    {
        ...
        var ex = Assert.Throws<InvalidOperationException>(() =>
            new AzureArtifactSigningCertificateSource(mockSignContext.Object));
    ...
    public void Constructor_WithValidCertChain_CreatesInstance()
    {
        ...
        // Act
        var source = new AzureArtifactSigningCertificateSource(mockSignContext.Object);
