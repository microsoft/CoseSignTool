...
namespace CoseSign1.Certificates.AzureArtifactSigning.Extensions;

using CoseSign1.Headers;

/// <summary>
/// Extension methods for configuring Azure Artifact Signing with SCITT compliance.
/// </summary>
public static class ScittExtensions
{
    /// <summary>
    /// Configures certificate signing options for SCITT compliance with Azure Artifact Signing.
    ...
    /// <param name="certificateChain">The certificate chain from Azure Artifact Signing (leaf-first).</param>
        ...
        IEnumerable<System.Security.Cryptography.X509Certificates.X509Certificate2> certificateChain)
    {
        ...
        var issuer = AzureArtifactSigningDidX509.Generate(certificateChain);
