...
| `CoseSign1.Transparent.MST` | Merkle Search Tree receipts | Transparency with MST |
| `CoseSign1.Transparent.CTS` | Certificate Transparency Service | Transparency with CTS |
