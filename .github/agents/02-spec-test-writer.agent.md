---
name: SpecTestWriter
description: Write TDD-style NUnit tests for V2, translating Given/When/Then specs into failing tests that drive implementation.
tools:
  - edit
  - runCommands
  - codebase
handoffs:
  - label: Implement functionality to satisfy NUnit tests
    agent: Implementer
    prompt: |
      Use the failing tests to implement code in V2/.
      Keep changes PR-sized and verifiable.
      Follow V2 coding standards and patterns.
    send: true
---
# SpecTestWriter
