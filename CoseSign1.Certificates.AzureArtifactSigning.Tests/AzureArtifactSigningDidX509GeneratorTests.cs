...
/// <summary>
/// Unit tests for the <see cref="AzureArtifactSigningDidX509Generator"/> class.
/// Tests Azure Artifact Signing specific DID generation with Microsoft EKU support.
/// </summary>
[TestFixture]
public class AzureArtifactSigningDidX509GeneratorTests
{
    private AzureArtifactSigningDidX509Generator Generator = null!;

    [SetUp]
    public void SetUp()
    {
        Generator = new AzureArtifactSigningDidX509Generator();
    }
    ...
    {
        // Act & Assert
        ArgumentNullException ex = Assert.Throws<ArgumentNullException>(() => Generator.GenerateFromChain(null!));
    ...
    public void GenerateFromChain_WithEmptyChain_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        ArgumentException ex = Assert.Throws<ArgumentException>(() => Generator.GenerateFromChain(emptyChain));
    ...
    {
        // Arrange - Azure Artifact Signing certificate with Microsoft EKU
        ...
        // Assert - Should use EKU-based format (Azure Artifact Signing specific)
        Assert.That(did, Does.StartWith("did:x509:0:sha256:"));
    ...
    {
        // Arrange - Non-Microsoft EKU (not Azure Artifact Signing)
    ...
    {
        // Arrange - Lifetime Signing is a Microsoft EKU that triggers Azure Artifact Signing format
        List<string> ekus = new()
        {
    ...
    {
        var method = typeof(AzureArtifactSigningDidX509Generator)
        ...
        return (T)method.Invoke(Generator, args)!;
    }
