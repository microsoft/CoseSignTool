...
public interface ITransparencyProvider
{
    ...
    /// <summary>
    /// Gets the URI of the transparency service endpoint that this provider communicates with.
    /// </summary>
    /// <remarks>
    /// Returns <c>null</c> if no endpoint was configured or is not applicable.
    /// </remarks>
