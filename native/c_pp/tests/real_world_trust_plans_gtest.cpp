...
TEST(RealWorldTrustPlans, RealScittPolicyCanRequireCwtClaimsAndMstReceiptTrustedFromIssuer) {
...

    {
        ...
        ASSERT_EQ(cose_sign1_validator_builder_with_mst_pack_ex(builder.native_handle(), &opts), COSE_OK);
    }
...
#ifdef COSE_HAS_CERTIFICATES_PACK
    {
        ...
        ASSERT_EQ(cose_sign1_validator_builder_with_certificates_pack_ex(builder.native_handle(), &cert_opts), COSE_OK);
    }
#endif
