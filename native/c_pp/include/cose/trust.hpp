...
public:
    explicit TrustPlanBuilder(const ValidatorBuilder& validator_builder) {
        ...
        detail::ThrowIfNotOkOrNull(status, builder_);
    }
    ...
    TrustPlanBuilder& AddAllPackDefaultPlans() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_plan_builder_add_all_pack_default_plans(builder_));
        return *this;
    }
    ...
    size_t PackCount() const {
        CheckBuilder();
        size_t count = 0;
        detail::ThrowIfNotOk(cose_trust_plan_builder_pack_count(builder_, &count));
        return count;
    }
    ...
    bool PackHasDefaultPlan(size_t index) const {
        ...
        detail::ThrowIfNotOk(cose_trust_plan_builder_pack_has_default_plan(builder_, index, &has_default));
        return has_default;
    }

    TrustPlanBuilder& ClearSelectedPlans() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_plan_builder_clear_selected_plans(builder_));
        return *this;
    }
    ...
    CompiledTrustPlan CompileOr() {
        ...
        detail::ThrowIfNotOkOrNull(status, out);
...
public:
    ...
    TrustPolicyBuilder& And() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_and(builder_));
        return *this;
    }

    TrustPolicyBuilder& Or() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_or(builder_));
        return *this;
    }

    TrustPolicyBuilder& RequireContentTypeNonEmpty() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_content_type_non_empty(builder_));
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireDetachedPayloadPresent() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_detached_payload_present(builder_));
        return *this;
    }

    TrustPolicyBuilder& RequireDetachedPayloadAbsent() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_detached_payload_absent(builder_));
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimsPresent() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_claims_present(builder_));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtClaimsAbsent() {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_claims_absent(builder_));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtIssEq(const std::string& iss) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_iss_eq(builder_, iss.c_str()));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtSubEq(const std::string& sub) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_sub_eq(builder_, sub.c_str()));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtAudEq(const std::string& aud) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_aud_eq(builder_, aud.c_str()));
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelPresent(int64_t label) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_present(builder_, label)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextPresent(const std::string& key) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_present(builder_, key.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelI64Eq(int64_t label, int64_t value) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_i64_eq(builder_, label, value)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelBoolEq(int64_t label, bool value) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_bool_eq(builder_, label, value)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelI64Ge(int64_t label, int64_t min) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_i64_ge(builder_, label, min)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelI64Le(int64_t label, int64_t max) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_i64_le(builder_, label, max)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextStrEq(const std::string& key, const std::string& value) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_str_eq(builder_, key.c_str(), value.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelStrEq(int64_t label, const std::string& value) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_str_eq(builder_, label, value.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelStrStartsWith(int64_t label, const std::string& prefix) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_str_starts_with(builder_, label, prefix.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextStrStartsWith(
        ...
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_str_starts_with(builder_, key.c_str(), prefix.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimLabelStrContains(int64_t label, const std::string& needle) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_label_str_contains(builder_, label, needle.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextStrContains(
        ...
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_str_contains(builder_, key.c_str(), needle.c_str())
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextBoolEq(const std::string& key, bool value) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_bool_eq(builder_, key.c_str(), value)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextI64Eq(const std::string& key, int64_t value) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_i64_eq(builder_, key.c_str(), value)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextI64Ge(const std::string& key, int64_t min) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_i64_ge(builder_, key.c_str(), min)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtClaimTextI64Le(const std::string& key, int64_t max) {
        CheckBuilder();
        detail::ThrowIfNotOk(
            cose_trust_policy_builder_require_cwt_claim_text_i64_le(builder_, key.c_str(), max)
        );
        return *this;
    }
    ...
    TrustPolicyBuilder& RequireCwtExpGe(int64_t min) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_exp_ge(builder_, min));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtExpLe(int64_t max) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_exp_le(builder_, max));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtNbfGe(int64_t min) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_nbf_ge(builder_, min));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtNbfLe(int64_t max) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_nbf_le(builder_, max));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtIatGe(int64_t min) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_iat_ge(builder_, min));
        return *this;
    }

    TrustPolicyBuilder& RequireCwtIatLe(int64_t max) {
        CheckBuilder();
        detail::ThrowIfNotOk(cose_trust_policy_builder_require_cwt_iat_le(builder_, max));
        return *this;
    }
