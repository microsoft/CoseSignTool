...
# Remote signing (Azure Artifact Signing)
cosesigntool sign input.bin --provider azure-artifact-signing \
...
│   ├── AzureArtifactSigning.Plugin.dll
│   └── plugin.json
├── custom-validator/
...
```json
{
  ...
  "version": "2.0.0",
  "author": "Microsoft",
  "description": "Azure Artifact Signing certificate provider",
  "type": "CertificateProvider",
  "assembly": "AzureArtifactSigning.Plugin.dll",
  "entryPoint": "AzureArtifactSigning.Plugin.AzureArtifactSigningPlugin"
}
```
...
```bash
COSESIGNTOOL_CERT_PROVIDER=azure-artifact-signing
...
- ✅ Built-in plugins (Azure Artifact Signing, etc.)
