...
/// <summary>
/// Signing service for Azure Artifact Signing.
/// Implements the V2 certificate-based signing pattern for remote signing services.
/// </summary>
/// <remarks>
/// Azure Artifact Signing is a Microsoft-managed cloud signing service that provides:
...
/// </remarks>
public class AzureArtifactSigningService : CertificateSigningService
{
    [ExcludeFromCodeCoverage]
    internal static class ClassStrings
    {
        public const string ServiceName = "AzureArtifactSigning";
        public const string Description = "Microsoft Azure Artifact Signing service with FIPS 140-2 Level 3 HSM-backed keys";
    ...
    private readonly AzureArtifactSigningCertificateSource CertificateSource;

    /// <summary>
    /// Initializes a new instance of the <see cref="AzureArtifactSigningService"/> class.
    /// </summary>
    /// <param name="signContext">The Azure Artifact Signing context from the SDK. This will be reused across operations.</param>
    ...
    public AzureArtifactSigningService(
        ...
        : base(isRemote: true, serviceMetadata ?? CreateDefaultMetadata())
    {
        ...
        CertificateSource = new AzureArtifactSigningCertificateSource(SignContext, chainBuilder);
    }

    /// <summary>
    /// Creates default service metadata for Azure Artifact Signing.
    /// </summary>
    ...
    /// Returns the same certificate source instance for all operations (Azure Artifact Signing uses a single key per profile).
    /// </summary>
    /// <param name="context">The signing context.</param>
    /// <returns>An ISigningKey that provides access to the Azure Artifact Signing key operations.</returns>
    protected override ISigningKey GetSigningKey(SigningContext context)
    {
        // Azure Artifact Signing uses a single key per signing profile
