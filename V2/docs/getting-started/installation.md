...
| Package | Description | When to Use |
|---------|-------------|-------------|
| `CoseSign1.Certificates.AzureArtifactSigning` | Azure Artifact Signing integration | Cloud-based signing with Azure |
...
| `CoseSignTool.AzureArtifactSigning.Plugin` | Azure Artifact Signing | Standalone plugin usage |
