...
fn test_error_display_missing_policies() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: must contain at least one policy"
    );
}
...
fn test_error_display_invalid_format() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: expected format 'expected:format'"
    );
}
...
fn test_error_display_unsupported_version() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: unsupported version '1', expected '0'"
    );
}
...
fn test_error_display_unsupported_hash_algorithm() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: unsupported hash algorithm 'md5'"
    );
}
...
fn test_error_display_empty_fingerprint() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: CA fingerprint cannot be empty"
    );
}
...
fn test_error_display_fingerprint_length_mismatch() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: CA fingerprint length mismatch for sha256 (expected 32, got 16)"
    );
}
...
fn test_error_display_invalid_policy_format() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: policy must have format 'type:value'"
    );
}
...
fn test_error_display_empty_policy_name() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: policy name cannot be empty"
    );
}
...
fn test_error_display_empty_policy_value() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid DID: policy value cannot be empty"
    );
}
...
fn test_error_display_empty_subject_policy_key() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid subject policy: key cannot be empty"
    );
}
...
fn test_error_display_duplicate_subject_policy_key() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid subject policy: duplicate key 'CN'"
    );
}
...
fn test_error_display_invalid_san_policy_format() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid SAN policy: must have format 'type:value'"
    );
}
...
fn test_error_display_invalid_san_type() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid SAN policy: SAN type must be 'email', 'dns', 'uri', or 'dn' (got 'invalid')"
    );
}
...
fn test_error_display_empty_fulcio_issuer() {
    ...
    assert_eq!(
        error.to_string(),
        "Invalid Fulcio issuer policy: issuer cannot be empty"
    );
}
...
fn test_error_display_percent_decoding_error() {
    ...
    assert_eq!(
        error.to_string(),
        "Percent decoding error: Invalid escape sequence"
    );
}
...
fn test_error_display_certificate_parse_error() {
    ...
    assert_eq!(
        error.to_string(),
        "Certificate parse error: DER decoding failed"
    );
}
...
fn test_error_display_policy_validation_failed() {
    ...
    assert_eq!(
        error.to_string(),
        "Policy validation failed: Subject mismatch"
    );
}
...
fn test_error_display_no_ca_match() {
    ...
    assert_eq!(
        error.to_string(),
        "No CA certificate in chain matches fingerprint"
    );
}
