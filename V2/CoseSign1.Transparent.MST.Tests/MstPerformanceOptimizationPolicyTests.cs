...
public class MstPerformanceOptimizationPolicyTests
{
    ...
    public async Task ProcessAsync_NonGetRequest_PassesThroughWithoutRetry()
    {
        ...
        HttpPipeline pipeline = CreatePipeline(transport, new MstPerformanceOptimizationPolicy(TimeSpan.FromMilliseconds(1), 3));
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Post, "https://mst.example.com/entries/1.234");
    ...
    public async Task ProcessAsync_GetNonEntriesPath_PassesThroughWithoutRetry()
    {
        ...
        HttpPipeline pipeline = CreatePipeline(transport, new MstPerformanceOptimizationPolicy(TimeSpan.FromMilliseconds(1), 3));
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/operations/abc");
    ...
    public async Task ProcessAsync_GetEntriesPath_Non503Status_PassesThroughWithoutRetry()
    {
        ...
        HttpPipeline pipeline = CreatePipeline(transport, new MstPerformanceOptimizationPolicy(TimeSpan.FromMilliseconds(1), 3));
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/entries/1.234");
    ...
    public async Task ProcessAsync_TransactionNotCached_RetriesUntilSuccess()
    {
        ...
        HttpPipeline pipeline = CreatePipeline(transport, new MstPerformanceOptimizationPolicy(TimeSpan.FromMilliseconds(1), 5));
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/entries/1.234");
    ...
    public async Task ProcessAsync_TransactionNotCached_ExhaustsRetries_Returns503()
    {
        ...
        int maxRetries = 3;
        HttpPipeline pipeline = CreatePipeline(transport, new MstPerformanceOptimizationPolicy(TimeSpan.FromMilliseconds(1), maxRetries));
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/entries/1.234");
    ...
    public async Task ProcessAsync_ZeroMaxRetries_NoRetries()
    {
        ...
        HttpPipeline pipeline = CreatePipeline(transport, new MstPerformanceOptimizationPolicy(TimeSpan.FromMilliseconds(1), 0));
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/entries/1.234");
    ...
    public void ConfigureMstPerformanceOptimizations_DefaultParams_ReturnsSameInstance()
    {
        ...
        CodeTransparencyClientOptions result = options.ConfigureMstPerformanceOptimizations();
    ...
    public async Task Baseline_WithoutPolicy_SdkRespectsRetryAfterDelay()
    {
        ...
        SdkRetryTestClientOptions options = new(transport, policy: null);
    ...
    public async Task PolicyAtPerRetry_FastRetryResolvesBeforeSdkRetryAfterDelay()
    {
        ...
        MstPerformanceOptimizationPolicy policy = new(TimeSpan.FromMilliseconds(10), 5);
        SdkRetryTestClientOptions options = new(transport, policy, HttpPipelinePosition.PerRetry);
        HttpPipeline pipeline = HttpPipelineBuilder.Build(options);
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/entries/1.234");
    ...
    public async Task PolicyAt100msDelay_ResolvesWellUnder500ms()
    {
        ...
        MstPerformanceOptimizationPolicy policy = new(TimeSpan.FromMilliseconds(100), 5);
        SdkRetryTestClientOptions options = new(transport, policy, HttpPipelinePosition.PerRetry);
        HttpPipeline pipeline = HttpPipelineBuilder.Build(options);
        HttpMessage message = CreateHttpMessage(pipeline, RequestMethod.Get, "https://mst.example.com/entries/1.234");
    ...
    public async Task PolicyWithZeroRetries_StillStripsRetryAfterHeader()
    {
        ...
        MstPerformanceOptimizationPolicy policy = new(TimeSpan.FromMilliseconds(10), 0);
        CodeTransparencyClientOptions options = new()
        {
            Transport = transport,
    ...
    public async Task ActivitySource_503Resolved_EmitsRetryActivityWithAttempts()
    {
        ...
        MstPerformanceOptimizationPolicy policy = new(TimeSpan.FromMilliseconds(10), 5);
        TestClientOptions options = new(transport, policy);
        HttpPipeline pipeline = HttpPipelineBuilder.Build(options);
    ...
    public async Task ActivitySource_RetriesExhausted_EmitsExhaustedActivity()
    {
        ...
        MstPerformanceOptimizationPolicy policy = new(TimeSpan.FromMilliseconds(10), 3);
        TestClientOptions options = new(transport, policy);
        HttpPipeline pipeline = HttpPipelineBuilder.Build(options);
    ...
    public async Task ActivitySource_Non503Response_NoActivitiesEmitted()
    {
        ...
        MockTransport transport = MockTransport.FromMessageCallback(msg => new MockResponse(200));
