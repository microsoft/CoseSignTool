...
description: Design and evolve V2 architecture with interface-based, DI-friendly patterns for signing services, factories, and validators.
tools:
  - edit
  - runCommands
  - codebase
handoffs:
  - label: Generate TDD tests from spec updates
    ...
    prompt: |
      Create NUnit tests from the updated specs using Given/When/Then scenarios.
      Use failing tests to define implementation boundaries.
      Follow V2 test patterns in CoseSign1.Tests and related test projects.
    send: true
---
