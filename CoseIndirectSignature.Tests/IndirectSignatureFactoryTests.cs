...
public class IndirectSignatureFactoryTests
{
    ...
    public async Task TestCreateIndirectSignatureAsync()
    {
        ...
        IndirectSignature.ProtectedHeaders[CoseHeaderLabel.ContentType].GetValueAsString().Should().Be("application/test.payload+cose_hash_v");
        ...
        IndirectSignature2.ProtectedHeaders[CoseHeaderLabel.ContentType].GetValueAsString().Should().Be("application/test.payload+cose_hash_v");
        ...
        IndirectSignature3.ProtectedHeaders[CoseHeaderLabel.ContentType].GetValueAsString().Should().Be("application/test.payload+cose_hash_v");
        ...
        IndirectSignature4.ProtectedHeaders[CoseHeaderLabel.ContentType].GetValueAsString().Should().Be("application/test.payload+cose_hash_v");
