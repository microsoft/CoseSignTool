...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_present(
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_not_present(
    policy_builder: *mut cose_trust_policy_builder_t,
) -> cose_status_t {
    with_catch_unwind(|| {
        with_trust_policy_builder_mut(policy_builder, |b| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_signature_verified(
    policy_builder: *mut cose_trust_policy_builder_t,
) -> cose_status_t {
    with_catch_unwind(|| {
        with_trust_policy_builder_mut(policy_builder, |b| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_signature_not_verified(
    policy_builder: *mut cose_trust_policy_builder_t,
) -> cose_status_t {
    with_catch_unwind(|| {
        with_trust_policy_builder_mut(policy_builder, |b| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_issuer_contains(
    policy_builder: *mut cose_trust_policy_builder_t,
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_issuer_eq(
    policy_builder: *mut cose_trust_policy_builder_t,
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_kid_eq(
    policy_builder: *mut cose_trust_policy_builder_t,
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_kid_contains(
    policy_builder: *mut cose_trust_policy_builder_t,
    needle_utf8: *const c_char,
) -> cose_status_t {
    with_catch_unwind(|| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_trusted(
    policy_builder: *mut cose_trust_policy_builder_t,
) -> cose_status_t {
    with_catch_unwind(|| {
        with_trust_policy_builder_mut(policy_builder, |b| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_not_trusted(
    policy_builder: *mut cose_trust_policy_builder_t,
) -> cose_status_t {
    with_catch_unwind(|| {
        with_trust_policy_builder_mut(policy_builder, |b| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_trusted_from_issuer_contains(
    policy_builder: *mut cose_trust_policy_builder_t,
    needle_utf8: *const c_char,
) -> cose_status_t {
    with_catch_unwind(|| {
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_statement_sha256_eq(
    policy_builder: *mut cose_trust_policy_builder_t,
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_statement_coverage_eq(
    policy_builder: *mut cose_trust_policy_builder_t,
...
#[no_mangle]
pub extern "C" fn cose_mst_trust_policy_builder_require_receipt_statement_coverage_contains(
    policy_builder: *mut cose_trust_policy_builder_t,
    needle_utf8: *const c_char,
) -> cose_status_t {
    with_catch_unwind(|| {
