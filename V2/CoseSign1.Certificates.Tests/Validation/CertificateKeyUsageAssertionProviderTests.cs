...
public class CertificateKeyUsageAssertionProviderTests
{
    ...
    {
        var testCert = TestCertificateUtils.CreateCertificate("KeyUsageTest");
    ...
    {
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.DigitalSignature);
    ...
    public void Constructor_WithOid_CreatesValidator()
    {
        ...
        var validator = new CertificateKeyUsageAssertionProvider(oid);
        Assert.That(validator, Is.Not.Null);
    }
    ...
    {
        var validator = new CertificateKeyUsageAssertionProvider("1.3.6.1.5.5.7.3.3");
        Assert.That(validator, Is.Not.Null);
    }
    ...
    public void Constructor_WithNullOidString_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() =>
            new CertificateKeyUsageAssertionProvider((string)null!));
    }
    ...
    public void Validate_WithNullInput_ReturnsFailure()
    {
        ...
        Assert.That(result.ValidatorName, Is.EqualTo(nameof(CertificateKeyUsageAssertionProvider)));
    ...
    public void Validate_WithValidKeyUsage_ReturnsSuccess()
    {
        ...
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.KeyCertSign);
    ...
    public void Validate_WithWrongKeyUsage_ReturnsFailure()
    {
        ...
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.CrlSign);
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    public void Validate_WithWrongEKU_ReturnsFailure()
    {
        ...
        var validator = new CertificateKeyUsageAssertionProvider("1.2.3.4.5.6"); // Non-existent EKU
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    {
        using var ctx = CreateTestContext();
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.KeyCertSign, allowUnprotectedHeaders: true);
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    {
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.DigitalSignature, allowUnprotectedHeaders: true);
        Assert.That(validator, Is.Not.Null);
    }
    ...
    {
        var oid = new Oid("1.3.6.1.5.5.7.3.3");
        var validator = new CertificateKeyUsageAssertionProvider(oid, allowUnprotectedHeaders: true);
        Assert.That(validator, Is.Not.Null);
    }
    ...
    {
        var validator = new CertificateKeyUsageAssertionProvider("1.3.6.1.5.5.7.3.3", allowUnprotectedHeaders: true);
        Assert.That(validator, Is.Not.Null);
    }
    ...
    {
        using var ctx = CreateTestContext();
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.KeyCertSign | X509KeyUsageFlags.CrlSign);
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    public void Validate_WithEkuUsingOidWithFriendlyName_IncludesInMetadata()
    {
        ...
        var validator = new CertificateKeyUsageAssertionProvider(oidWithFriendlyName);
        var result = validator.Validate(message, ValidationStage.KeyMaterialTrust);
    ...
    public void Validate_WithNoneKeyUsageFlags_ReturnsAppropriateResult()
    {
        ...
        var validator = new CertificateKeyUsageAssertionProvider(X509KeyUsageFlags.None);
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
    ...
    {
        using var ctx = CreateTestContext();
        var validator = new CertificateKeyUsageAssertionProvider("1.2.3.4.5.6.7.8.9");
        var result = validator.Validate(ctx.ValidMessage, ValidationStage.KeyMaterialTrust);
